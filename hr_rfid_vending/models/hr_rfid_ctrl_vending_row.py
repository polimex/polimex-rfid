...
class HrRfidVendingRow(models.Model):
    ...
    item_number1 = fields.Char(string='#1', compute='_compute_number_1')
    item_number2 = fields.Char(string='#2', compute='_compute_number_2')
    item_number3 = fields.Char(string='#3', compute='_compute_number_3')
    item_number4 = fields.Char(string='#4', compute='_compute_number_4')
