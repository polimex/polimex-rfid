...
class Digest(models.Model):
    ...
    kpi_hr_rfid_vending_refill_value = fields.Float(compute='_compute_kpi_hr_rfid_vending_values')
    kpi_hr_rfid_vending_sale_value = fields.Float(compute='_compute_kpi_hr_rfid_vending_values')
    kpi_hr_rfid_vending_sale_count_value = fields.Float(compute='_compute_kpi_hr_rfid_vending_values')
    ...
    def _compute_kpi_hr_rfid_vending_values(self):
        ...
        for record in self:
            ...
            record.kpi_hr_rfid_vending_sale_value = sum(h.balance_change for h in vending_history.filtered(lambda bh: bh.balance_change < 0))
