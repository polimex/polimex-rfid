# -*- coding: utf-8 -*-
"""
Migration 15.0.2.5.1 — Repair orphan cards left behind by _deactivate race.
...
def migrate(cr, version):
    _logger.info("Starting hr_rfid post-migration 15.0.2.5.1 (orphan card repair)")

    env = api.Environment(cr, SUPERUSER_ID, {})

    # Cards whose owner has an active access group rel but which have NO door rels.
    ...
    _logger.info(
        "Post-migration 15.0.2.5.1 complete: repaired=%d, skipped=%d, total=%d",
